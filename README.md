...
To build the final jar and optimize the jhipstermogodb application for production, run:
...
Then navigate to [http://localhost:4000](http://localhost:4000) in your browser.
