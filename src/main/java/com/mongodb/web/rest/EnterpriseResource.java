package com.mongodb.web.rest;

import com.mongodb.repository.EnterpriseRepository;
import com.mongodb.service.EnterpriseService;
import com.mongodb.service.dto.EnterpriseDTO;
import com.mongodb.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.mongodb.domain.Enterprise}.
 */
@RestController
...
public class EnterpriseResource {
    ...
    public ResponseEntity<EnterpriseDTO> createEnterprise(@Valid @RequestBody EnterpriseDTO enterpriseDTO) throws URISyntaxException {
        ...
        enterpriseDTO = enterpriseService.save(enterpriseDTO);
        return ResponseEntity.created(new URI("/api/enterprises/" + enterpriseDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, enterpriseDTO.getId()))
            .body(enterpriseDTO);
    }
    ...
    public ResponseEntity<EnterpriseDTO> updateEnterprise(
        ...
        enterpriseDTO = enterpriseService.update(enterpriseDTO);
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<EnterpriseDTO> getEnterprise(@PathVariable("id") String id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteEnterprise(@PathVariable("id") String id) {
