    ...
    <Row>
      <Col md="8">
        <h2 data-cy="absenceDetailsHeading">
          <Translate contentKey="jhipstermogodbApp.absence.detail.title">Absence</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="jhipstermogodbApp.absence.employee">Employee</Translate>
          </dt>
