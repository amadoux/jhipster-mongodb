  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipstermogodbApp.absence.home.createOrEditLabel" data-cy="AbsenceCreateUpdateHeading">
            <Translate contentKey="jhipstermogodbApp.absence.home.createOrEditLabel">Create or edit a Absence</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipstermogodbApp.absence.startDate')}
              ...
              />
              <ValidatedField
                label={translate('jhipstermogodbApp.absence.endDate')}
                id="absence-endDate"
                name="endDate"
                data-cy="endDate"
                type="datetime-local"
              ...
              />
              <ValidatedField
                label={translate('jhipstermogodbApp.absence.numberDayAbsence')}
              ...
              />
              <ValidatedField
                label={translate('jhipstermogodbApp.absence.typeAbsence')}
              ...
              >
                {typeAbsenceValues.map(typeAbsence => (
                  <option value={typeAbsence} key={typeAbsence}>
                    {translate('jhipstermogodbApp.TypeAbsence.' + typeAbsence)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('jhipstermogodbApp.absence.confirmationAbsence')}
              ...
              >
                {confirmationAbsenceValues.map(confirmationAbsence => (
                  <option value={confirmationAbsence} key={confirmationAbsence}>
                    {translate('jhipstermogodbApp.ConfirmationAbsence.' + confirmationAbsence)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('jhipstermogodbApp.absence.congeRestant')}
              ...
              <ValidatedField
                ...
                name="employee"
                data-cy="employee"
                label={translate('jhipstermogodbApp.absence.employee')}
                type="select"
              >
                <option value="" key="0" />
                {employees
