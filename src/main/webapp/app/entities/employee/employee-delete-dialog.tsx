...
export const EmployeeDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipstermogodbApp.employee.delete.question">
        <Translate contentKey="jhipstermogodbApp.employee.delete.question" interpolate={{ id: employeeEntity.id }}>
