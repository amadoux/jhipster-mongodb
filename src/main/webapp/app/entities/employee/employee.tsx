  ...
  return (
    <div>
      <h2 id="employee-heading" data-cy="EmployeeHeading">
        <Translate contentKey="jhipstermogodbApp.employee.home.title">Employees</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="jhipstermogodbApp.employee.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/employee/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipstermogodbApp.employee.home.createLabel">Create new Employee</Translate>
          </Link>
        </div>
      </h2>
        ...
        {employeeList && employeeList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="jhipstermogodbApp.employee.id">ID</Translate>{' '}
                ...
                <th>
                  <Translate contentKey="jhipstermogodbApp.employee.enterprise">Enterprise</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
            ...
            <tbody>
              {employeeList.map((employee, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`jhipstermogodbApp.Pays.${employee.nationality}`} />
                  </td>
                  <td>
                  ...
                  <td>
                    <Translate contentKey={`jhipstermogodbApp.TypeEmployed.${employee.typeEmployed}`} />
                  </td>
                  ...
                  <td>
                    <Translate contentKey={`jhipstermogodbApp.Department.${employee.department}`} />
                  </td>
                  <td>
                    <Translate contentKey={`jhipstermogodbApp.Level.${employee.level}`} />
                  </td>
                  ...
                  <td>
                    <Translate contentKey={`jhipstermogodbApp.ContractType.${employee.contractType}`} />
                  </td>
                  <td>
                    <Translate contentKey={`jhipstermogodbApp.SalaryType.${employee.salaryType}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipstermogodbApp.employee.home.notFound">No Employees found</Translate>
            </div>
          )
        )}
      </div>
