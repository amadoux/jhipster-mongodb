  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipstermogodbApp.employee.home.createOrEditLabel" data-cy="EmployeeCreateUpdateHeading">
            <Translate contentKey="jhipstermogodbApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipstermogodbApp.employee.firstName')}
              ...
              />
              <ValidatedField
                label={translate('jhipstermogodbApp.employee.lastName')}
              ...
              />
              <ValidatedField
                label={translate('jhipstermogodbApp.employee.email')}
                id="employee-email"
                name="email"
                data-cy="email"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('jhipstermogodbApp.employee.phoneNumber')}
              ...
              />
              <ValidatedField
                label={translate('jhipstermogodbApp.employee.identityCard')}
              ...
              />
              <ValidatedField
                label={translate('jhipstermogodbApp.employee.dateInspiration')}
              ...
              />
              <ValidatedField
                label={translate('jhipstermogodbApp.employee.nationality')}
              ...
              >
                {paysValues.map(pays => (
                  <option value={pays} key={pays}>
                    {translate('jhipstermogodbApp.Pays.' + pays)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedBlobField
                label={translate('jhipstermogodbApp.employee.uploadIdentityCard')}
              ...
              />
              <ValidatedField
                label={translate('jhipstermogodbApp.employee.typeEmployed')}
              ...
              >
                {typeEmployedValues.map(typeEmployed => (
                  <option value={typeEmployed} key={typeEmployed}>
                    {translate('jhipstermogodbApp.TypeEmployed.' + typeEmployed)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('jhipstermogodbApp.employee.cityAgency')}
              ...
              />
              <ValidatedField
                label={translate('jhipstermogodbApp.employee.residenceCity')}
              ...
              />
              <ValidatedField
                label={translate('jhipstermogodbApp.employee.address')}
                id="employee-address"
                name="address"
                data-cy="address"
                type="text"
              />
              <ValidatedField
                label={translate('jhipstermogodbApp.employee.socialSecurityNumber')}
              ...
              />
              <ValidatedField
                label={translate('jhipstermogodbApp.employee.birthDate')}
              ...
              />
              <ValidatedField
                label={translate('jhipstermogodbApp.employee.birthPlace')}
              ...
              />
              <ValidatedField
                label={translate('jhipstermogodbApp.employee.entryDate')}
              ...
              />
              <ValidatedField
                label={translate('jhipstermogodbApp.employee.releaseDate')}
              ...
              />
              <ValidatedField
                label={translate('jhipstermogodbApp.employee.workstation')}
              ...
              />
              <ValidatedField
                label={translate('jhipstermogodbApp.employee.descriptionWorkstation')}
              ...
              />
              <ValidatedField
                label={translate('jhipstermogodbApp.employee.department')}
              ...
              >
                {departmentValues.map(department => (
                  <option value={department} key={department}>
                    {translate('jhipstermogodbApp.Department.' + department)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('jhipstermogodbApp.employee.level')}
                id="employee-level"
                name="level"
                data-cy="level"
                type="select"
              >
                {levelValues.map(level => (
                  <option value={level} key={level}>
                    {translate('jhipstermogodbApp.Level.' + level)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('jhipstermogodbApp.employee.coefficient')}
              ...
              />
              <ValidatedField
                label={translate('jhipstermogodbApp.employee.numberHours')}
              ...
              />
              <ValidatedField
                label={translate('jhipstermogodbApp.employee.averageHourlyCost')}
              ...
              />
              <ValidatedField
                label={translate('jhipstermogodbApp.employee.monthlyGrossAmount')}
              ...
              />
              <ValidatedField
                label={translate('jhipstermogodbApp.employee.commissionAmount')}
              ...
              />
              <ValidatedField
                label={translate('jhipstermogodbApp.employee.contractType')}
              ...
              >
                {contractTypeValues.map(contractType => (
                  <option value={contractType} key={contractType}>
                    {translate('jhipstermogodbApp.ContractType.' + contractType)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('jhipstermogodbApp.employee.salaryType')}
              ...
              >
                {salaryTypeValues.map(salaryType => (
                  <option value={salaryType} key={salaryType}>
                    {translate('jhipstermogodbApp.SalaryType.' + salaryType)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('jhipstermogodbApp.employee.hireDate')}
              ...
              <ValidatedField
                ...
                name="enterprise"
                data-cy="enterprise"
                label={translate('jhipstermogodbApp.employee.enterprise')}
                type="select"
              >
                <option value="" key="0" />
                {enterprises
              ...
              <ValidatedField
                ...
                label={translate('jhipstermogodbApp.employee.managerEmployee')}
                type="select"
              >
                <option value="" key="0" />
                {employees
