...
export const ContractDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/contract' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipstermogodbApp.contract.delete.question">
        <Translate contentKey="jhipstermogodbApp.contract.delete.question" interpolate={{ id: contractEntity.id }}>
