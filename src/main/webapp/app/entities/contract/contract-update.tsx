  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipstermogodbApp.contract.home.createOrEditLabel" data-cy="ContractCreateUpdateHeading">
            <Translate contentKey="jhipstermogodbApp.contract.home.createOrEditLabel">Create or edit a Contract</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipstermogodbApp.contract.contractType')}
              ...
              <UncontrolledTooltip target="contractTypeLabel">
                <Translate contentKey="jhipstermogodbApp.contract.help.contractType" />
              </UncontrolledTooltip>
              <ValidatedField
                label={translate('jhipstermogodbApp.contract.entryDate')}
              ...
              />
              <ValidatedField
                label={translate('jhipstermogodbApp.contract.releaseDate')}
              ...
              />
              <ValidatedField
                label={translate('jhipstermogodbApp.contract.statusContract')}
              ...
              >
                {statusContractValues.map(statusContract => (
                  <option value={statusContract} key={statusContract}>
                    {translate('jhipstermogodbApp.StatusContract.' + statusContract)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedBlobField
                label={translate('jhipstermogodbApp.contract.uploadContract')}
              ...
              <ValidatedField
                ...
                name="employee"
                data-cy="employee"
                label={translate('jhipstermogodbApp.contract.employee')}
                type="select"
              >
                <option value="" key="0" />
                {employees
