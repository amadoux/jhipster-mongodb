    ...
    <Row>
      <Col md="8">
        <h2 data-cy="contractDetailsHeading">
          <Translate contentKey="jhipstermogodbApp.contract.detail.title">Contract</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="jhipstermogodbApp.contract.employee">Employee</Translate>
          </dt>
