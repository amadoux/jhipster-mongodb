  ...
  return (
    <div>
      <h2 id="contract-heading" data-cy="ContractHeading">
        <Translate contentKey="jhipstermogodbApp.contract.home.title">Contracts</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="jhipstermogodbApp.contract.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/contract/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipstermogodbApp.contract.home.createLabel">Create new Contract</Translate>
          </Link>
        </div>
      </h2>
        ...
        {contractList && contractList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="jhipstermogodbApp.contract.id">ID</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('contractType')}>
                  <Translate contentKey="jhipstermogodbApp.contract.contractType">Contract Type</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('contractType')} />
                </th>
                <th className="hand" onClick={sort('entryDate')}>
                  <Translate contentKey="jhipstermogodbApp.contract.entryDate">Entry Date</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('entryDate')} />
                </th>
                <th className="hand" onClick={sort('releaseDate')}>
                  <Translate contentKey="jhipstermogodbApp.contract.releaseDate">Release Date</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('releaseDate')} />
                </th>
                <th className="hand" onClick={sort('statusContract')}>
                  <Translate contentKey="jhipstermogodbApp.contract.statusContract">Status Contract</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('statusContract')} />
                </th>
                <th className="hand" onClick={sort('uploadContract')}>
                  <Translate contentKey="jhipstermogodbApp.contract.uploadContract">Upload Contract</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('uploadContract')} />
                </th>
                <th>
                  <Translate contentKey="jhipstermogodbApp.contract.employee">Employee</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {contractList.map((contract, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`jhipstermogodbApp.ContractType.${contract.contractType}`} />
                  </td>
                  ...
                  <td>
                    <Translate contentKey={`jhipstermogodbApp.StatusContract.${contract.statusContract}`} />
                  </td>
                  <td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipstermogodbApp.contract.home.notFound">No Contracts found</Translate>
            </div>
          )
        )}
      </div>
