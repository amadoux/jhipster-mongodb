...
export const SocialChargesDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipstermogodbApp.socialCharges.delete.question">
        <Translate contentKey="jhipstermogodbApp.socialCharges.delete.question" interpolate={{ id: socialChargesEntity.id }}>
