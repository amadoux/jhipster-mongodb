  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipstermogodbApp.socialCharges.home.createOrEditLabel" data-cy="SocialChargesCreateUpdateHeading">
            <Translate contentKey="jhipstermogodbApp.socialCharges.home.createOrEditLabel">Create or edit a SocialCharges</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipstermogodbApp.socialCharges.spentDate')}
              ...
              />
              <ValidatedField
                label={translate('jhipstermogodbApp.socialCharges.spentType')}
              ...
              >
                {sPentTypeValues.map(sPentType => (
                  <option value={sPentType} key={sPentType}>
                    {translate('jhipstermogodbApp.SPentType.' + sPentType)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('jhipstermogodbApp.socialCharges.statusCharges')}
              ...
              >
                {statusChargesValues.map(statusCharges => (
                  <option value={statusCharges} key={statusCharges}>
                    {translate('jhipstermogodbApp.StatusCharges.' + statusCharges)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('jhipstermogodbApp.socialCharges.amount')}
              ...
              />
              <ValidatedField
                label={translate('jhipstermogodbApp.socialCharges.commentText')}
              ...
              <ValidatedField
                ...
                label={translate('jhipstermogodbApp.socialCharges.responsableDepense')}
                type="select"
              >
                <option value="" key="0" />
                {employees
              ...
              <ValidatedField
                ...
                name="enterprise"
                data-cy="enterprise"
                label={translate('jhipstermogodbApp.socialCharges.enterprise')}
                type="select"
              >
                <option value="" key="0" />
                {enterprises
