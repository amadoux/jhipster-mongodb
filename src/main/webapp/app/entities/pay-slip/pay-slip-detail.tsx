    ...
    <Row>
      <Col md="8">
        <h2 data-cy="paySlipDetailsHeading">
          <Translate contentKey="jhipstermogodbApp.paySlip.detail.title">PaySlip</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="jhipstermogodbApp.paySlip.employee">Employee</Translate>
          </dt>
