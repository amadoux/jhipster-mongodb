  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipstermogodbApp.paySlip.home.createOrEditLabel" data-cy="PaySlipCreateUpdateHeading">
            <Translate contentKey="jhipstermogodbApp.paySlip.home.createOrEditLabel">Create or edit a PaySlip</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipstermogodbApp.paySlip.netSalaryPay')}
              ...
              <UncontrolledTooltip target="netSalaryPayLabel">
                <Translate contentKey="jhipstermogodbApp.paySlip.help.netSalaryPay" />
              </UncontrolledTooltip>
              <ValidatedField
                label={translate('jhipstermogodbApp.paySlip.paySlipDate')}
              ...
              />
              <ValidatedBlobField
                label={translate('jhipstermogodbApp.paySlip.uploadPaySlip')}
              ...
              <ValidatedField
                ...
                name="employee"
                data-cy="employee"
                label={translate('jhipstermogodbApp.paySlip.employee')}
                type="select"
              >
                <option value="" key="0" />
                {employees
