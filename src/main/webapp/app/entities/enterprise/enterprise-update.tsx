  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipstermogodbApp.enterprise.home.createOrEditLabel" data-cy="EnterpriseCreateUpdateHeading">
            <Translate contentKey="jhipstermogodbApp.enterprise.home.createOrEditLabel">Create or edit a Enterprise</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipstermogodbApp.enterprise.companyName')}
              ...
              <ValidatedField
                label={translate('jhipstermogodbApp.enterprise.businessRegisterNumber')}
              ...
              />
              <ValidatedField
                label={translate('jhipstermogodbApp.enterprise.uniqueIdentificationNumber')}
              ...
              />
              <ValidatedField
                label={translate('jhipstermogodbApp.enterprise.businessDomicile')}
              ...
              />
              <ValidatedField
                label={translate('jhipstermogodbApp.enterprise.email')}
                id="enterprise-email"
                name="email"
                data-cy="email"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('jhipstermogodbApp.enterprise.businessPhone')}
              ...
              />
              <ValidatedField
                label={translate('jhipstermogodbApp.enterprise.country')}
              ...
              <ValidatedField
                label={translate('jhipstermogodbApp.enterprise.city')}
                id="enterprise-city"
                name="city"
                data-cy="city"
                type="text"
              />
              <ValidatedBlobField
                label={translate('jhipstermogodbApp.enterprise.businessLogo')}
              ...
              />
              <ValidatedBlobField
                label={translate('jhipstermogodbApp.enterprise.mapLocator')}
