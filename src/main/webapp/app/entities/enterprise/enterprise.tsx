  ...
  return (
    <div>
      <h2 id="enterprise-heading" data-cy="EnterpriseHeading">
        <Translate contentKey="jhipstermogodbApp.enterprise.home.title">Enterprises</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="jhipstermogodbApp.enterprise.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/enterprise/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipstermogodbApp.enterprise.home.createLabel">Create new Enterprise</Translate>
          </Link>
        </div>
      </h2>
        ...
        {enterpriseList && enterpriseList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="jhipstermogodbApp.enterprise.id">ID</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('companyName')}>
                  <Translate contentKey="jhipstermogodbApp.enterprise.companyName">Company Name</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('companyName')} />
                </th>
                <th className="hand" onClick={sort('businessRegisterNumber')}>
                  <Translate contentKey="jhipstermogodbApp.enterprise.businessRegisterNumber">Business Register Number</Translate>{' '}
                ...
                <th className="hand" onClick={sort('uniqueIdentificationNumber')}>
                  <Translate contentKey="jhipstermogodbApp.enterprise.uniqueIdentificationNumber">Unique Identification Number</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('uniqueIdentificationNumber')} />
                </th>
                <th className="hand" onClick={sort('businessDomicile')}>
                  <Translate contentKey="jhipstermogodbApp.enterprise.businessDomicile">Business Domicile</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('businessDomicile')} />
                </th>
                <th className="hand" onClick={sort('email')}>
                  <Translate contentKey="jhipstermogodbApp.enterprise.email">Email</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('email')} />
                </th>
                <th className="hand" onClick={sort('businessPhone')}>
                  <Translate contentKey="jhipstermogodbApp.enterprise.businessPhone">Business Phone</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('businessPhone')} />
                </th>
                <th className="hand" onClick={sort('country')}>
                  <Translate contentKey="jhipstermogodbApp.enterprise.country">Country</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('country')} />
                </th>
                <th className="hand" onClick={sort('city')}>
                  <Translate contentKey="jhipstermogodbApp.enterprise.city">City</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('city')} />
                </th>
                <th className="hand" onClick={sort('businessLogo')}>
                  <Translate contentKey="jhipstermogodbApp.enterprise.businessLogo">Business Logo</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('businessLogo')} />
                </th>
                <th className="hand" onClick={sort('mapLocator')}>
                  <Translate contentKey="jhipstermogodbApp.enterprise.mapLocator">Map Locator</Translate>{' '}
            ...
            <tbody>
              {enterpriseList.map((enterprise, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`jhipstermogodbApp.Pays.${enterprise.country}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipstermogodbApp.enterprise.home.notFound">No Enterprises found</Translate>
            </div>
          )
        )}
      </div>
