...
export const EnterpriseDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipstermogodbApp.enterprise.delete.question">
        <Translate contentKey="jhipstermogodbApp.enterprise.delete.question" interpolate={{ id: enterpriseEntity.id }}>
